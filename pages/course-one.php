        ...
        $courseGroups = [
            ...
            'full-stack' => [
                ...
                'courses' => [
                    ...
                    ['Java Full Stack', 'java-full-stack-course-jaipur-mango-engineers.webp', 'Frontend foundations plus Java backend, Spring ecosystem, APIs and databases.', 'java-full-stack-course-jaipur.html'],
                    ...
                    ['React JS', 'react-js-course-jaipur-mango-engineers.webp', 'Component-based frontend development with state, routing and API integration.', 'react-js-course-jaipur.html'],
                    ['Node.js', 'node-js-course-jaipur-mango-engineers.webp', 'JavaScript backend development with APIs, databases and server-side application structure.', 'node-js-course-jaipur.html'],
                ],
            ],
            'data-ai' => [
                ...
                'courses' => [
                    ['Data Analytics', 'power-bi-course-jaipur-mango-engineers.webp', 'Analytics workflow covering spreadsheets, SQL, reporting and dashboard skills.', 'data-analytics-course-jaipur.html'],
                    ['Power BI', 'power-bi-course-jaipur-mango-engineers.webp', 'Data modelling, reporting and interactive dashboard development with Power BI.', 'power-bi-course-jaipur.html'],
                    ['Data Science', 'data-science-course-jaipur-mango-engineers.webp', 'Python, data handling, analysis, statistics and machine learning foundations.', 'data-science-course-jaipur.html'],
                    ['Machine Learning', 'machine-learning-course-jaipur-mango-engineers.webp', 'Supervised and unsupervised learning concepts with practical model workflows.', 'machine-learning-course-jaipur.html'],
                    ['Artificial Intelligence', 'artificial-intelligence-course-jaipur-mango-engineers.webp', 'AI foundations and practical problem-solving pathways using modern tools.', 'artificial-intelligence-course-jaipur.html'],
                    ['Generative AI', 'generative-ai-course-jaipur-mango-engineers.webp', 'Modern GenAI concepts, prompting, application workflows and practical use cases.', 'generative-ai-course-jaipur.html'],
                    ['SQL', 'data-science-course-jaipur-mango-engineers.webp', 'Relational database querying, joins, aggregation and analytics-focused SQL practice.', 'sql-course-jaipur.html'],
                    ['Excel & Advanced Excel', 'power-bi-course-jaipur-mango-engineers.webp', 'Spreadsheet analysis, formulas, lookups, pivots, cleaning and practical reporting.', 'excel-advanced-excel-course-jaipur.html'],
                ],
            ],
            'cloud-devops' => [
