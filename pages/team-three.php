            ...
            <div class="container">
                <div class="breadcrumb-inner">
                    <div class="page-title">
                        <h1 class="title">leadership Instruction</h1>
                    </div>
                    <ul class="edu-breadcrumb">
                        ...
                        <li class="separator"><i class="icon-angle-right"></i></li>
                        <li class="breadcrumb-item active" aria-current="page">Instructors 3</li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="edu-team-grid team-style-3">
                            <div class="inner">
                                <div class="thumbnail-wrap">
                                    <div class="thumbnail">
                                        <a href="team-details.html">
                                            <img src="assets/images/team/team-08.webp" alt="team images">
                                        </a>
                                    </div>
                                    <ul class="team-share-info">
                                        <li><a href="#"><i class="icon-facebook"></i></a></li>
                        ...
                        <div class="edu-team-grid team-style-3">
                            <div class="inner">
                                <div class="thumbnail-wrap">
                                    <div class="thumbnail">
                                        <a href="team-details.html">
                                            <img src="assets/images/team/team-16.webp" alt="team images">
                                        </a>
                                    </div>
                                    <ul class="team-share-info">
                                        <li><a href="#"><i class="icon-facebook"></i></a></li>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="team-details.html">Michael Douglas</a></h5>
                                    <span class="designation">Teacher</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="edu-team-grid team-style-3">
                            <div class="inner">
                                <div class="thumbnail-wrap">
                                    <div class="thumbnail">
                                        <a href="team-details.html">
                                            <img src="assets/images/team/team-17.webp" alt="team images">
                                        </a>
                                    </div>
                                    <ul class="team-share-info">
                                        <li><a href="#"><i class="icon-facebook"></i></a></li>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="team-details.html">Hilary Swank</a></h5>
                                    <span class="designation">Teacher</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="edu-team-grid team-style-3">
                            <div class="inner">
                                <div class="thumbnail-wrap">
                                    <div class="thumbnail">
                                        <a href="team-details.html">
                                            <img src="assets/images/team/team-18.webp" alt="team images">
                                        </a>
                                    </div>
                                    <ul class="team-share-info">
                                        <li><a href="#"><i class="icon-facebook"></i></a></li>
                                ...
                                <div class="content">
                                    <h5 class="title"><a href="team-details.html">Steve Martin</a></h5>
                                    <span class="designation">Teacher</span>
                                </div>
                            </div>
                        </div>
