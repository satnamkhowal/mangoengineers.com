        ...
        <div class="edu-breadcrumb-area breadcrumb-style-7">
            ...
            <ul class="shape-group">
                ...
                <li class="shape-5"><img data-depth="2" src="assets/images/others/shape-80.png" alt="shape"></li>
            </ul>
        </div>
        ...
        <section class="edu-section-gap course-details-area">
            <div class="container">
                <div class="row row--30">
                    <div class="col-lg-8">
                        <div class="course-details-content course course-details-5">
