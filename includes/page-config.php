...
function mango_page_definitions(): array
{
    return [
        ...
        'full-stack-development-course-jaipur' => ['name' => 'Full Stack Developer Course in Jaipur', 'description' => 'Learn full stack development in Jaipur with modern JavaScript, React-oriented frontend work, Node.js, REST APIs, SQL, NoSQL, Git, deployment and practical projects at Mango Engineers.', 'schema_type' => 'ItemPage', 'robots' => 'index,follow', 'entity_type' => 'Course'],
        ...
        'data-science-course-jaipur' => ['name' => 'Data Science Course in Jaipur', 'description' => 'Learn Python, data analysis, statistics and machine learning foundations with practical projects at Mango Engineers Jaipur.', 'schema_type' => 'ItemPage', 'robots' => 'index,follow', 'entity_type' => 'Course'],
        'machine-learning-course-jaipur' => ['name' => 'Machine Learning Course in Jaipur', 'description' => 'Learn supervised and unsupervised machine learning, model evaluation and practical ML workflows with Python at Mango Engineers Jaipur.', 'schema_type' => 'ItemPage', 'robots' => 'index,follow', 'entity_type' => 'Course'],
        'artificial-intelligence-course-jaipur' => ['name' => 'Artificial Intelligence Course in Jaipur', 'description' => 'Learn AI foundations, machine learning concepts and practical intelligent-application workflows at Mango Engineers Jaipur.', 'schema_type' => 'ItemPage', 'robots' => 'index,follow', 'entity_type' => 'Course'],
        'generative-ai-course-jaipur' => ['name' => 'Generative AI Course in Jaipur', 'description' => 'Learn LLM foundations, prompt engineering, GenAI application workflows, RAG concepts and responsible AI use at Mango Engineers Jaipur.', 'schema_type' => 'ItemPage', 'robots' => 'index,follow', 'entity_type' => 'Course'],
        'devops-course-jaipur' => ['name' => 'DevOps Course in Jaipur', 'description' => 'Learn Linux, Git, CI/CD, Docker, Kubernetes and cloud deployment foundations with practical DevOps workflows at Mango Engineers Jaipur.', 'schema_type' => 'ItemPage', 'robots' => 'index,follow', 'entity_type' => 'Course'],
        'aws-course-jaipur' => ['name' => 'AWS Course in Jaipur', 'description' => 'Learn cloud computing and core AWS concepts including compute, storage, networking, identity and deployment foundations at Mango Engineers Jaipur.', 'schema_type' => 'ItemPage', 'robots' => 'index,follow', 'entity_type' => 'Course'],
        'linux-course-jaipur' => ['name' => 'Linux Course in Jaipur', 'description' => 'Learn Linux command line, users, permissions, processes, services, networking and shell automation foundations at Mango Engineers Jaipur.', 'schema_type' => 'ItemPage', 'robots' => 'index,follow', 'entity_type' => 'Course'],
        'docker-course-jaipur' => ['name' => 'Docker Course in Jaipur', 'description' => 'Learn Docker containers, images, Dockerfiles, volumes, networks and Compose-oriented workflows at Mango Engineers Jaipur.', 'schema_type' => 'ItemPage', 'robots' => 'index,follow', 'entity_type' => 'Course'],
        'kubernetes-course-jaipur' => ['name' => 'Kubernetes Course in Jaipur', 'description' => 'Learn Kubernetes pods, deployments, services, configuration, scaling and orchestration foundations at Mango Engineers Jaipur.', 'schema_type' => 'ItemPage', 'robots' => 'index,follow', 'entity_type' => 'Course'],
        'microsoft-azure-course-jaipur' => ['name' => 'Microsoft Azure Course in Jaipur', 'description' => 'Learn Azure cloud fundamentals, compute, storage, networking, identity and deployment concepts at Mango Engineers Jaipur.', 'schema_type' => 'ItemPage', 'robots' => 'index,follow', 'entity_type' => 'Course'],
        'ethical-hacking-course-jaipur' => ['name' => 'Ethical Hacking Course in Jaipur', 'description' => 'Learn cyber security, networking, authorised ethical testing concepts and defensive security foundations at Mango Engineers Jaipur.', 'schema_type' => 'ItemPage', 'robots' => 'index,follow', 'entity_type' => 'Course'],
        'ui-ux-design-course-jaipur' => ['name' => 'UI/UX Design Course in Jaipur', 'description' => 'Learn UX foundations, wireframing, Figma, interface design, prototyping and portfolio case-study development at Mango Engineers Jaipur.', 'schema_type' => 'ItemPage', 'robots' => 'index,follow', 'entity_type' => 'Course'],
        'digital-marketing-course-jaipur' => ['name' => 'Digital Marketing Course in Jaipur', 'description' => 'Learn SEO, social media, paid advertising, analytics and integrated digital marketing workflows at Mango Engineers Jaipur.', 'schema_type' => 'ItemPage', 'robots' => 'index,follow', 'entity_type' => 'Course'],
        'angular-course-jaipur' => ['name' => 'Angular Course in Jaipur', 'description' => 'Learn Angular, TypeScript, components, routing, forms, services and API integration through practical frontend projects at Mango Engineers Jaipur.', 'schema_type' => 'ItemPage', 'robots' => 'index,follow', 'entity_type' => 'Course'],
        'next-js-course-jaipur' => ['name' => 'Next.js Course in Jaipur', 'description' => 'Learn Next.js routing, rendering, data fetching, API integration and deployment-oriented React application development at Mango Engineers Jaipur.', 'schema_type' => 'ItemPage', 'robots' => 'index,follow', 'entity_type' => 'Course'],
        'flutter-course-jaipur' => ['name' => 'Flutter Course in Jaipur', 'description' => 'Learn Dart and Flutter to build cross-platform Android and iOS applications with practical mobile projects at Mango Engineers Jaipur.', 'schema_type' => 'ItemPage', 'robots' => 'index,follow', 'entity_type' => 'Course'],
        'android-app-development-course-jaipur' => ['name' => 'Android App Development Course in Jaipur', 'description' => 'Learn Android app development, UI, navigation, storage, APIs and mobile project development at Mango Engineers Jaipur.', 'schema_type' => 'ItemPage', 'robots' => 'index,follow', 'entity_type' => 'Course'],
        'php-course-jaipur' => ['name' => 'PHP Course in Jaipur', 'description' => 'Learn PHP server-side development, forms, sessions, databases and CRUD web application development at Mango Engineers Jaipur.', 'schema_type' => 'ItemPage', 'robots' => 'index,follow', 'entity_type' => 'Course'],
        'c-cpp-programming-course-jaipur' => ['name' => 'C and C++ Programming Course in Jaipur', 'description' => 'Learn C and C++ programming, logic building, pointers and object-oriented programming foundations at Mango Engineers Jaipur.', 'schema_type' => 'ItemPage', 'robots' => 'index,follow', 'entity_type' => 'Course'],
    ];
}
